...
QFontAwesomeAnimation::QFontAwesomeAnimation(QWidget *parentWidget, int interval, int step)
...
void QFontAwesomeAnimation::setup(QPainter &painter, const QRect &rect)
{
...
void QFontAwesomeAnimation::update()
{
    angle_ += step_;
